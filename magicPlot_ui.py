...
class Ui_MagicPlot(object):
    def setupUi(self, MagicPlot):
        ...
        self.gridLayout_2.addWidget(self.getLiveData, 1, 4, 1, 1)
        self.saveFitsFile = QtGui.QPushButton(MagicPlot)
        self.saveFitsFile.setObjectName(_fromUtf8("saveFitsFile"))
        self.gridLayout_2.addWidget(self.saveFitsFile, 1, 1, 1, 1)
        self.plot1dRealtime = QtGui.QPushButton(MagicPlot)
        self.plot1dRealtime.setObjectName(_fromUtf8("plot1dRealtime"))
        self.gridLayout_2.addWidget(self.plot1dRealtime, 0, 4, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.bufferSizeSlider, 0, 5, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.subApDraw, 1, 5, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.drawCentroids, 2, 0, 1, 1)
        self.drawArr = QtGui.QCheckBox(MagicPlot)
        self.drawArr.setObjectName(_fromUtf8("drawArr"))
        self.gridLayout_2.addWidget(self.drawArr, 2, 1, 1, 1)
        self.drawRefCents = QtGui.QCheckBox(MagicPlot)
        self.drawRefCents.setObjectName(_fromUtf8("drawRefCents"))
        self.gridLayout_2.addWidget(self.drawRefCents, 2, 4, 1, 1)
        self.but1dSlopes = QtGui.QPushButton(MagicPlot)
        self.but1dSlopes.setObjectName(_fromUtf8("but1dSlopes"))
        self.gridLayout_2.addWidget(self.but1dSlopes, 2, 5, 1, 1)
        self.toolButton = QtGui.QToolButton(MagicPlot)
    ...
    def retranslateUi(self, MagicPlot):
        ...
        self.saveFitsFile.setText(_translate("MagicPlot", "Save as FITS", None))
        ...
        self.but1dSlopes.setText(_translate("MagicPlot", "1D Slopes", None))
        self.toolButton.setText(_translate("MagicPlot", "...", None))
